...
If you like to read further on the how Gatsby is designed to achieve high performance, [this GitHub issue](gatsby-performance-issue) which is created at the start of Gatsby's 1.0 release will be a good read.
