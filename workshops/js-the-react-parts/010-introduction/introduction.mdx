...
5. This site is created for this workshop, and will be always available online (except if Netlify shuts down).
   - [star this repo](https://github.com/malcolm-kee/javascript-the-react-parts)
   - share this with anyone that you think would benefits from this.

## Who Am I?

My name is Malcolm. I'm a frontend developer at a Denmark insurance company called Topdanmark, working with React and AWS. I also work in open source project and organize [React KL Meetup][react-meetup]. Prior to that, I worked in Accenture and a startup company.

I enjoys teaching, programming, and reading.
