...
You can see spread operator as opposite of [destructuring](/destructuring/); destructuring decomposes an array or object to its smaller item/ properties, while spread operator is used to merge smaller array/object into a bigger one.
