...
<div id="currying-example" style="margin-bottom:32px;">
  ...
  <button id="bulbasaur" data-sound="bulbasaur-sound" class="button">
    Bulbasaur
  </button>
  <button id="charmander" data-sound="charmander-sound" class="button">
    Charmander
  </button>
  <button id="squirtle" data-sound="squirtle-sound" class="button">
    Squirtle
  </button>
</div>
...
We will utilize currying in [next lesson](/functional-programming/).
...
<div id="currying-exercise" style="margin-bottom:75px;">
  ...
  <p>I am text</p>
  <div>
    <button id="size-12" data-color="red" class="button">
      Red 12
    </button>
    <button id="size-14" data-color="blue" class="button">
      Blue 14
    </button>
    <button id="size-16" data-color="yellow" class="button">
      Yellow 16
    </button>
  </div>
</div>
