...
import { FilterAnimation } from '@app/components/array-animations/filter';
import { MapAnimation } from '@app/components/array-animations/map';
import { ReduceAnimation } from '@app/components/array-animations/reduce';
