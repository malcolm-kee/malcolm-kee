...
![The graph of f(x) = 2x.](https://res.cloudinary.com/djzsjzasg/image/upload/v1674485483/malcolm-kee/y_2x_ski4rf.png)
...
![The graph of f(x) = x square - 5.](https://res.cloudinary.com/djzsjzasg/image/upload/v1674485483/malcolm-kee/y_2x2-5_ien0il.png)
...
const getFirstNames = (persons) => persons.map((person) => person.name.split(' ')[0]);
