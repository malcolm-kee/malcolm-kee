...
![Plugins can be used to enhance build process of Gatsby](https://res.cloudinary.com/djzsjzasg/image/upload/v1674488309/malcolm-kee/gatsbyjs-overview-highlight-build_vjgala.png)
...
```scss title="src/_constants.scss"
$space: 8px;
...
```scss title="src/components/header.scss" {0,3,6,8,10}
@import '../constants';
...
```scss title="src/components/layout.scss" {0}
@import '../constants';
