...
![Components are main building blocks of a Gatsby site](https://res.cloudinary.com/djzsjzasg/image/upload/v1674487841/malcolm-kee/gatsbyjs-overview-highlight-component_yxo02t.png)
...
```json title="package.json" highlightedLines=7
{
  "name": "learn-gatsby",
  "version": "1.0.0",
  "description": "",
...
```jsx title="src/pages/index.js" {1,5,8}
import * as React from 'react';
...
```jsx title="src/pages/404.js" {1,5,8}
import * as React from 'react';
import { Layout } from '../components/layout';
...
```jsx title="src/components/header.jsx" {1}
import * as React from 'react';
import './header.css';
...
```jsx title="src/components/layout.jsx" {2}
import * as React from 'react';
import { Header } from './header';
import './layout.css';
...
```jsx title="src/pages/about-me.js"
import * as React from 'react';
import { Layout } from '../components/layout';
...
```jsx title="src/pages/index.js" {0,9}
...
```jsx title="src/pages/404.js" {0,9}
import { Link } from 'gatsby';
import * as React from 'react';
import { Layout } from '../components/layout';
...
```jsx title="src/pages/about-me.js" {0,12}
import { Link } from 'gatsby';
import * as React from 'react';
import { Layout } from '../components/layout';
