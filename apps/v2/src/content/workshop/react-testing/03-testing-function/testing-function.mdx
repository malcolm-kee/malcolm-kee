...
```js title="src/lib/camelize.spec.js"
...
```js title="src/lib/camelize.spec.js" {4-7}
import { camelize } from './camelize';
...
```js title="src/lib/camelize.js" {8,9}
...
```js title="src/lib/object.spec.js"
...
![Intellisense in VS Code showing assertions](https://res.cloudinary.com/djzsjzasg/image/upload/v1674563121/malcolm-kee/jest-intellisense_s5hglw.png)
