...
![Initial Output](https://res.cloudinary.com/djzsjzasg/image/upload/v1674383062/malcolm-kee/initial-output_cq06ql.png)

<Exercise title="Do It: Type the code">
...
```js
function App(props) {
  return React.createElement('div', {}, React.createElement('h1', {}, props.appTitle));
}
...
<Exercise title="Do It: Create your Movie Component">
