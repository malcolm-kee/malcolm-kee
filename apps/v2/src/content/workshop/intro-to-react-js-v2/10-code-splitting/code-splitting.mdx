...
<Exercise title="Do It: lazy loading ajax call code">
...
export default Movie; // [!code highlight]
```
...
const Movie = React.lazy(() => import('./components/movie')); // [!code highlight]
...
<Exercise title="Do It: lazy loading React Component">
