...
![VS Code Icon](https://res.cloudinary.com/djzsjzasg/image/upload/v1674395658/malcolm-kee/vs-code-icon_ksrjfm.png)
...
- You can open any file by its name when you type `Ctrl+P` (Quick Open).
  ...
  ![After type Ctrl+P, type the file name to show the available files in your project](https://res.cloudinary.com/djzsjzasg/image/upload/v1674395655/malcolm-kee/quick-open_t3ogyh.png)
...
- You can navigate symbols inside a file with `Ctrl+Shift+O` or `Ctrl+P` and type `@`.
  ...
  ![Go to Symbol](https://res.cloudinary.com/djzsjzasg/image/upload/v1674395655/malcolm-kee/go-to-symbol_delhks.png)
