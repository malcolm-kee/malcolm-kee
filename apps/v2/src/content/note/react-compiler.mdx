...
To optimize this in runtime, we can wrap the component with `memo`[^1].
...
[^1]: Actually, we can further optimize this by having a module level cache, like this:
    ...
    In practice it's very rare so `memo` is usually enough.
