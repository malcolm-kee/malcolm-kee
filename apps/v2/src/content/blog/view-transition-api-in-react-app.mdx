...
<LiveEditor previewMinHeight="20rem" codeMaxHeight="40rem" readOnly fullBleed >
...
<LiveEditor previewMinHeight="20rem" codeMaxHeight="11rem" autoPlay readOnly>
...
### Update: React Router first-class support of View Transition
