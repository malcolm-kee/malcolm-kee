...
When I first write this article, there is no need to call `flushSync` before calling `navigate`. Somehow, the implementation changes and now it requires calling `flushSync`.
