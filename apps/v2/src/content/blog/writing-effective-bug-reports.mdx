...
import Aside from '@app/components/Aside.tsx';
...
![Replies by Programmers when their programs don't work](https://res.cloudinary.com/djzsjzasg/image/upload/v1764866216/malcolm-kee/denial_rjpprc.jpg)
...
![CNR](https://imgs.xkcd.com/comics/cnr.png)
