  ...
  if (variant === 'iconWithText') {
    return (
      <ul className="space-y-4">
        <SocialLinkWithText href={socialMediaData.twitter} Icon={TwitterIcon}>
          Follow on Twitter
        </SocialLinkWithText>
        <SocialLinkWithText href={socialMediaData.github} Icon={GitHubIcon}>
          Follow on GitHub
        </SocialLinkWithText>
        <SocialLinkWithText href={socialMediaData.linkedin} Icon={LinkedInIcon}>
          Follow on LinkedIn
        </SocialLinkWithText>
      </ul>
    );
