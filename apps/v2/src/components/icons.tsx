...
export function TinyChevronDownIcon(props: IconProps) {
  return (
...
export function TinyChevronDoubleDownIcon(props: IconProps) {
  return (
...
export function ArrowLeftIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" strokeWidth={1.5} {...props}>
      <path strokeLinecap="square" strokeLinejoin="miter" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
    </svg>
  );
}
