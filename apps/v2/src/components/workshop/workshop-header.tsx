...
export const WorkshopHeader = ({
  ...
  return (
    <header
      className={clsx(
        'sticky top-0 z-50 flex items-center sm:justify-between bg-white px-4 py-5 sm:py-3 shadow-md shadow-slate-900/5 transition duration-500 dark:shadow-none sm:px-6 lg:px-8',
        isScrolled
    ...
    >
      ...
      <div className="flex shrink-0 sm:flex-grow sm:basis-0 items-center">
      ...
      <div className="hidden sm:flex basis-0 justify-end items-center gap-6 sm:gap-8 sm:flex-grow ">
