...
export const CircleLetter = () => {
  ...
  return (
    <div className={container}>
      <div>
        <h2 className="py-4 text-gray-700 dark:text-gray-300 text-2xl">Circle Letters</h2>
        <CircleLetterCanvas key={key} text={text} onAnimationEnd={onAnimationEnd} />
      </div>
...
const CircleLetterCanvas = React.memo(({ text, onAnimationEnd, width = 600, height = 400 }) => {
  ...
  React.useEffect(() => {
    ...
    const data32 = new Uint32Array(context.getImageData(0, 0, width, height).data.buffer);
