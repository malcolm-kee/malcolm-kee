  ...
  <a
    ...
    className={clsx(
      ...
      props.hideAvatar
        ...
        : 'rounded-sm px-3 flex-row-reverse'
    )}
  >
    <span
      className={clsx(
        'block text-4xl font-techie font-bold drop-shadow-sm text-zinc-900 hover:text-primary-600 transition',
        !props.hideAvatar && [
          'sr-only',
...
export const IconContainer = ({
  ...
  <div
    {...props}
    className={clsx(
      'w-10 h-10 rounded-full p-0.5 backdrop-blur-sm shrink-0',
