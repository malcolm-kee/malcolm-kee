...
import simpleArchImg from './simple-architecture.png';
import simpleArchScaledImg from './simple-architecture-scaled.png';
...
<img
  alt="Architecture consistsing of a web service, a database service, and a websocket service"
  src={simpleArchImg}
/>
...
<img
  alt="Architecture consistsing of web service with multiple instances, a database service, and websocket service with multiple instances"
  src={simpleArchScaledImg}
/>
