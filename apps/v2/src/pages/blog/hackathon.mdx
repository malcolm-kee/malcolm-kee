...
import eventImg from './can-you-hack-it.jpg';
import teamMembersImg from './team-members.jpeg';
import codeAndSingImg from './me-coding-at-midnight-and-singing.jpeg';
import loanFormImg from './loan-form.png';
import bankApproval from './bank-approval.gif';
import approvalStatus from './approval-status.gif';
import finalPptImg from './top-10-presentation.jpeg';

<img src={eventImg} alt="Can You Hack It event banner" />
...
<img src={teamMembersImg} alt="Matt, Ale, and I" />
...
<img
  alt="I was coding while singing, and Matt took the snap"
  src={codeAndSingImg}
/>
...
<img
  src={loanFormImg}
  alt="The form that captures customer information required for loan application"
/>
...
<img
  src={bankApproval}
  alt="The portal that allow banks to review and approve/reject loan application"
/>
...
<img
  src={approvalStatus}
  alt="The portal that allow customer to review approval status and select the best loan"
/>
...
<img src={finalPptImg} alt="We presenting during the finalist presentation" />
