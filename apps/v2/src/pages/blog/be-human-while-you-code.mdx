...
import aHoleParkingImg from './asshole-parking.jpg';
import mouseStickImg from './mouse-stick.jpg';
import screenReaderImg from './screen-reader.jpg';
...
<img alt="A blind person using screen reader" src={screenReaderImg} />
...
<img src={mouseStickImg} alt="A handicapped person using mouse stick" />
...
<img src={aHoleParkingImg} alt="A**hole parking at reserved parking" />
