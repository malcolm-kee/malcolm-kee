...
The key of writing idiomatic code is, it is easy to read and understand, thus in the event that you need to do optimization, it is easier to analyze as well. In other words, you can _assume_ performance, but prioritize on writing idiomatic code, because idiomatic code is easy to change or optimized later.
